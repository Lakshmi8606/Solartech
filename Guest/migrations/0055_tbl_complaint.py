...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Guest', '0054_delete_tbl_complaint'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pcomplaint_name', models.CharField(max_length=500)),
                ('pcomplaint_content', models.CharField(max_length=500)),
                ('pcomplaint_postdate', models.DateField(auto_now_add=True)),
                ('pcomplaint_reply', models.CharField(max_length=500)),
                ('pcomplaint_replydate', models.DateField(null=True)),
                ('pcomplaint_status', models.IntegerField(default='0')),
